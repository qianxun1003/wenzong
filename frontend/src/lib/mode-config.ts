...
import { EJU_MODE_SUGGESTIONS } from "./eju-syllabus";
...
export const MODE_CONFIG: Record<AnswerMode, ModeConfig> = {
  basic: {
    ...
    sendHint: "以基础模式发送",
    suggestions: [...EJU_MODE_SUGGESTIONS.basic],
  ...
  eju: {
    ...
    sendHint: "以 EJU 模式发送",
    suggestions: [...EJU_MODE_SUGGESTIONS.eju],
  ...
  deep: {
    ...
    sendHint: "以深度模式发送",
    suggestions: [...EJU_MODE_SUGGESTIONS.deep],
  ...
  chart: {
    ...
    sendHint: "以图表模式发送",
    suggestions: [...EJU_MODE_SUGGESTIONS.chart],
